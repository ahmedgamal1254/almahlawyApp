...
return new class extends Migration
{
    ...
    {
        Schema::table('free_exams', function (Blueprint $table) {
            $table->dropForeign('free_exams_school_grade_id_foreign');
            $table->dropForeign('free_exams_subject_id_foreign');
            $table->dropForeign('free_exams_teacher_id_foreign');
            $table->dropForeign('free_exams_unit_id_foreign');
        });
    }
};
