...
return new class extends Migration
{
    ...
    {
        Schema::table('question_exam_students', function (Blueprint $table) {
            $table->dropForeign('question_exam_students_exam_id_foreign');
            $table->dropForeign('question_exam_students_school_grade_id_foreign');
            $table->dropForeign('question_exam_students_subject_id_foreign');
            $table->dropForeign('question_exam_students_teacher_id_foreign');
        });
    }
};
