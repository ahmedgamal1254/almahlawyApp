...
return new class extends Migration
{
    ...
    {
        Schema::table('free_books', function (Blueprint $table) {
    ...
    {
        Schema::table('free_books', function (Blueprint $table) {
            $table->dropForeign('free_books_school_grade_id_foreign');
            $table->dropForeign('free_books_subject_id_foreign');
            $table->dropForeign('free_books_teacher_id_foreign');
            $table->dropForeign('free_books_unit_id_foreign');
        });
    }
};
