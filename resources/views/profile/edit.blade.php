            ...
            <div class="main">
                ...
                <form action="{{ route("profile.store") }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" readonly value="{{ $student->email }}" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="أدخل البريد الالكترونى">
                    </div>
                    <div class="form-group">
                    ...
                    <fieldset class="form-group position-relative has-icon-left mb-0">
                        ...
                        <select name="government" id="" class="form-control form-control-lg">
                            <option value="{{ $student->government }}">أدخل اسم المحافظة</option>
                            @forelse ($governments as $government)
                            <option value="{{ $government->governorate_name_ar }}">{{ $government->governorate_name_ar }}</option>
                            @empty
                            @endforelse
                        </select>
