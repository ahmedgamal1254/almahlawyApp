                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="card custom-form-elements">
                                ...
                                <div class="table-header">
                                    ...
                                    <div class="table-action">
                                        <div class="table-link table-link-">
                                            <a href="{{ route("free-lessons") }}" class="btn btn-primary">
                            ...
                            <div class="card-body">
                                <form action="{{ route("free-lesson.update") }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <fieldset class="form-group position-relative has-icon-left mb-0">
                                        <input type="number" name="duration"
                                            class="form-control form-control-lg input-lg"
                                            value="{{ $lesson->duration }}" placeholder="أدخل مدة الدرس(الفيديو)">
                                        @error("duration")
                                            <span class="text-error">{{ $message }}</span>
                                        @enderror
                                    </fieldset>
