            ...
            <div class="col-md-12">
                <div class="card w-50 m-auto">
                    ...
                    <div style="margin: 20px;">
                        <a href="{{ route("free-lessons") }}" class="btn btn-outline-info" id="main">العودة للصفحة الرئيسية</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            init: {
                ...
                FileUploaded: function(up, file, result){
                    ...
                    setTimeout(() => {
                        location.href="{{ route("free-lessons") }}"
                    }, 3000);
                    ...
                    if (result.status != 200) {
                        toastr.error('عفوا لم يتم رفع الفيديو', 'Error Alert', {timeOut: 2000});
                    }

                    if (responseResult.ok==1 && result.status == 200) {
                        toastr.success('تم رفع الفيديو بنجاح', 'رفع الفيديو', {timeOut: 2000});
                    }
                },
