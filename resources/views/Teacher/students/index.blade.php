        ...
        <div class="card" style="padding: 20px;">
            <form action="{{ route("students.filter") }}" method="get">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12 mb">
                        <select style="width: 100%;" name="group" class="form-select form-control form-select-sm" id="search_school_grade" aria-label=".form-select-sm example">
                ...
                <tbody id="search_part">
                    <tr>
                        <td colspan="9">
                            ...
                            <div id="qloader" class="" style="display: none;">جارى التحميل</div>
                        </td>
                    </tr>
