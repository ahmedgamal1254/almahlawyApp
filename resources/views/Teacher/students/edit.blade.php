                        ...
                        <div class="card custom-form-elements">
                            ...
                            <div class="card-body">
                                <form action="{{ route("students.update") }}"  method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" value="{{ $student->password }}" value="old_password">
                                    <div class="form-group">
                                        <div class="media">
                                            ...
                                            <input type="hidden" name="old_img" value="{{ $student->profile }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $student->name }}"
                                        class="form-control"
                                        placeholder="مثال : خالد شبل" required />
                                        @error("name")
                                            <span class="text-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <select class="form-control select2 select-stage-select"
                                         data-placeholder="اختر الصف الدراسي" required name="school_grade_id">
                                            ...
                                            @forelse ($school_grades as $school_grade)
                                                <option
                                                    @if($student->school_grade_id == $student->school_grade_id) selected @endif
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        name="group_id">
                                            ...
                                            @empty
                                                <option value="">لا توجد مجموعة دراسية بعد</option>
                                            @endforelse
                                        </select>
                                        @error("group_id")
                                            <span class="text-error">{{ $message }}</span>
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        required name="government">
                                            ...
                                            @forelse ($governments as $item)
                                                <option
                                                    @if($student->government == $item->governorate_name_ar) selected @endif
                                                    value="{{ $item->governorate_name_ar }}">{{ $item->governorate_name_ar }}</option>
                                            @empty
