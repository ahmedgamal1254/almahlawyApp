...
<div class="notification-container">
    ...
    <div class="dropdown-box-header-title">
        ...
        <a href="{{ route("make_notifications_read") }}" class="btn btn-outline-success">جعلها كلها مقروءة</a>
    ...
    <div class="notification-content">
        ...
        <a href="{{ route("show_notification",["id"=>$item->id]) }}" class="noti-read">
            <div class="user-status">
                ...
                @if($item->type == 'App\Notifications\UploadVideoNotification')
                    <div class="user-status-title">
                        <span>{{ $item->data["message"] }} من قبل {{ $item->data["teacher_name"] }}</span>
                    </div>
                @endif
